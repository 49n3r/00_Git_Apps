...
st.set_page_config(page_title="Porous Carbon", page_icon="https://chinonsougwumadu.com/wp-content/uploads/2024/05/microsoftteams-image-17.jpg")
...
st.markdown(
    """
    This app construct porous carbon models by artificially creating a distribution of pores for a desired porosity in a 3D periodic box.
    Carbon atoms are then distributing in the regions not occupied by the pores
    ...
    - [Atomistic-to-Continuum Modeling of Carbon Foam: A New Approach to Finite Element Simulation](https://dx.doi.org/10.2139/ssrn.4877456), under peer-review in Carbon. 
    """
)
